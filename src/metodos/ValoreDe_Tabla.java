 ...
 * @author carlos
 */
public class ValoreDe_Tabla extends AbstractTableModel implements TableModelListener {
    ...
    public ValoreDe_Tabla(char tipoVector,int numFilasMatriz,int numColumnasMatriz){
